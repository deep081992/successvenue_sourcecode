...
<div class="container border p-2">
	...
	<div class="row mt-2">
		<div class="col-md-12">
			<h4>Examination Appeared(Only for Engineering)</h4>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6">
			Examination Name:
			<input type="text" class ="form-control"value="<?php echo $row['eng_exam_name']?>" >
		</div>
		
		<div class="col-md-6">
			Score:
			<input type="text" class ="form-control"value="<?php echo $row['eng_exam_score']?>">
		</div>
		
	</div>
	<div class="row mt-1">
		<div class="col-md-12">
			<h4>Examination Appeared (only for management)</h4>
					...
					<tr>
							...
							<?php echo $row['cmat_score']?>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['cmat_percentage']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['cmat_month_year']?>
							</textarea>
											</td>
										</tr>
				<tr>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['mat_score']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['mat_percentage']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['mat_month_year']?>
							</textarea>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['cat_score']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['cat_percentage']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['cat_month_year']?>
							</textarea>
											</td>
										</tr>						
	<tr>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['atma_score']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['atma_percentage']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['atma_month_year']?>
							</textarea>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['xat_score']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['xat_percentage']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['xat_month_year']?>
							</textarea>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['mh_cet_score']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['mh_cet_percentage']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['mh_cet_month_year']?>
							</textarea>
											</td>
										</tr>
										<tr>
											...
											<td>
												...
												<textarea class="form-control">
							<?php echo $row['other_score']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['other_percent']?>
							</textarea>
											</td>
											<td>
												
												<textarea class="form-control">
							<?php echo $row['other_month_year']?>
							</textarea>
											</td>
										</tr>
					</table>

If you do not have any entrance examination score, then you can participate in the College Entrance Exam.
		</div>
	</div>
	<div class="row mt-2">
		<div class="col-md-3">
		...
		<div class="col-md-6">
			<input type="text" class="form-control"value="<?php echo $row['mgt_program']?>">
		</div>
		<div class="col-md-3">
