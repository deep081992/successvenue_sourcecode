    ...
    <!-- /. NAV SIDE  -->
        <div id="page-wrapper" >
            ...
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="lead"><a class="text-dark" href="register_students.php"> Active Students</a></p>
            ...
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    ...
                    <p class="text-muted"><a href="applicationSubmitted.php">Application Submitted</a></p>
                </div>
             </div>
             </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">           
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    ...
                    <p class="text-muted"><a>Task Name</a></p>
                </div>
             </div>
             </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">           
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="text-muted"><a href="student_queries.php">Students Query</a></p>
                </div>
             </div>
             </div>
            </div>
